...
file_permissions=(
  ...
  ["/usr/local/bin/journal3rec"]="0:0:755"
  ["/usr/local/bin/multitranslatetest"]="0:0:755"
  ["/usr/local/bin/pcal"]="0:0:755"
  ["/usr/local/bin/ptimer"]="0:0:755"
  ["/usr/local/bin/sdm"]="0:0:755"
  ["/usr/local/bin/shlst"]="0:0:755"
  ["/usr/local/bin/smp"]="0:0:755"
  ["/usr/local/bin/StormOS_Expenses_Calculator"]="0:0:755"
  ["/usr/local/bin/stormy"]="0:0:755"
  ["/usr/local/bin/stormos-before"]="0:0:755"
  ["/usr/local/bin/stormos-final"]="0:0:755"
  ["/usr/local/bin/sfix"]="0:0:755"
  ["/usr/local/bin/stubet"]="0:0:755"
  ["/usr/local/bin/optimus"]="0:0:755"
